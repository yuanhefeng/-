/****************************************************************************
** Meta object code from reading C++ file 'interlock.h'
**
...
#error "The header file 'interlock.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 32, 11), // "TimerTicked"
QT_MOC_LITERAL(4, 44, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(5, 66, 23) // "on_pushButton_2_clicked"

    },
    "InterLock\0readPendingDatagrams\0\0"
    "TimerTicked\0on_pushButton_clicked\0"
...
void InterLock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        InterLock *_t = static_cast<InterLock *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject InterLock::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_InterLock.data,
      qt_meta_data_InterLock,  qt_static_metacall, nullptr, nullptr}
};
